...
namespace Stride.TextureConverter.PvrttWrapper
{
    ...
    internal class PVRTextureHeader : IDisposable
    {
        ...
        public Stride.Graphics.PixelFormat GetFormat()
        {
            ...
            {
                case 0:
                    return Stride.Graphics.PixelFormat.PVRTC_2bpp_RGB;
                case 1:
                    return Stride.Graphics.PixelFormat.PVRTC_2bpp_RGBA;
                case 2:
                    return Stride.Graphics.PixelFormat.PVRTC_4bpp_RGB;
                case 3:
                    return Stride.Graphics.PixelFormat.PVRTC_4bpp_RGBA;
                case 4:
                    return Stride.Graphics.PixelFormat.PVRTC_II_2bpp;
                case 5:
                    return Stride.Graphics.PixelFormat.PVRTC_II_4bpp;
                case 6:
