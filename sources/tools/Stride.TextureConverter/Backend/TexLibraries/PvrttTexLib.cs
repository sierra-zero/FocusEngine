    ...
    internal class PvrttTexLib : ITexLibrary
    {
        ...
        private bool SupportFormat(Stride.Graphics.PixelFormat format)
        {
            switch (format)
            {
                ...
                case Stride.Graphics.PixelFormat.PVRTC_2bpp_RGB:
                case Stride.Graphics.PixelFormat.PVRTC_2bpp_RGBA:
                case Stride.Graphics.PixelFormat.PVRTC_4bpp_RGB:
                case Stride.Graphics.PixelFormat.PVRTC_4bpp_RGBA:
                case Stride.Graphics.PixelFormat.PVRTC_II_2bpp:
                case Stride.Graphics.PixelFormat.PVRTC_II_4bpp:
                case Stride.Graphics.PixelFormat.PVRTC_2bpp_RGB_SRgb:
                case Stride.Graphics.PixelFormat.PVRTC_2bpp_RGBA_SRgb:
                case Stride.Graphics.PixelFormat.PVRTC_4bpp_RGB_SRgb:
                case Stride.Graphics.PixelFormat.PVRTC_4bpp_RGBA_SRgb:
