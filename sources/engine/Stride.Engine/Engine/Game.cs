    ...
    public class Game : GameBase, ISceneRendererContext, IGameSettingsService
    {
        ...
        protected override void PrepareContext()
        {
            ...
            if (Context.InitializeDatabase)
            {
                ...
                Stride.Graphics.Buffer.CaptureIndexBuffersOfSize = renderingSettings.CaptureIndexBufferOfSize;
                Stride.Graphics.Buffer.CaptureVertexBuffersOfSize = renderingSettings.CaptureVertexBufferOfSize;
