...
namespace Stride.Rendering
{
    ...
    public abstract class RootEffectRenderFeature : RootRenderFeature
    {
        ...
        private void PrepareRenderTargetExtensionsMixins(RenderDrawContext context)
        {
            ...
            Stride.Core.Threading.Dispatcher.ForEach<RenderNode>(RenderNodes, (renderNode) =>
            {
                ...
                if (renderEffect != null)
                {
                    ...
                    if (renderStageShaderSource != null)
                        renderEffect.EffectValidator.ValidateParameterThreaded(StrideEffectBaseKeys.RenderTargetExtensions, renderStageShaderSource);
                }
            });
        }
