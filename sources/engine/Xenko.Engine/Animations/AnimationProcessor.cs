...
namespace Xenko.Animations
{
    public class AnimationProcessor : EntityProcessor<AnimationComponent, AnimationProcessor.AssociatedData>
    {
        ...
        public override void Draw(RenderContext context)
        {
            ...
            Dispatcher.ForEach(ComponentDataValues, (this, time),
                delegate (ref (AnimationProcessor @this, Games.GameTime time) p, AssociatedData associatedData, FastList<AnimationOperation> animationOperations)
                {
