...
namespace Xenko.Rendering.Images
{
    internal static partial class ShaderMixins
    {
        internal partial class AmbientOcclusionBlurEffect  : IShaderMixinBuilder
        {
            ...
            {
                context.Mixin(mixin, "AmbientOcclusionBlurShader", context.GetParam(AmbientOcclusionBlurKeys.Count), context.GetParam(AmbientOcclusionBlurKeys.BlurScale), context.GetParam(AmbientOcclusionBlurKeys.EdgeSharpness));
            }
